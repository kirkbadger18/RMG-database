...
entry(
    index = 45,
    label = "XNHCH3 + Pt <=> XNCH3 + XH",
    kinetics = SurfaceArrhenius(
        A = (5.89E22, 'cm^2/(mol*s)'),  
        n = 0.0,
        Ea = (114, 'kJ/mol'),  
        Tmin = (200, 'K'),
        Tmax = (3000, 'K'),
